We think that the GUI software writes the xxx.rsi.xml and xxx.diagram files from user input, and the generates the xxx.rsi file which is loaded in software
